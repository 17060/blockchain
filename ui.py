...
def render_app(pulse=None, charts=None, briefing=None, error=None, form=None):
    ...
    parts = [
        ...
        '<style>',
        'body{margin:0;font-family:Georgia,serif;background:#eef3f0;color:#10233a;line-height:1.45}',
        'a{color:#065f5a}',
        '.wrap{max-width:960px;margin:0 auto;padding:24px 16px 48px}',
        'h1{font-size:42px;line-height:1;margin:0 0 8px;letter-spacing:-1px}',
        'h2{font-size:24px;margin:32px 0 8px;border-top:1px solid #c5d0c9;padding-top:20px}',
        ...
        'input[type=text],input[type=date]{width:100%;max-width:320px;padding:10px;font:inherit;border:1px solid #8aa}',
        ...
        'th,td{border:1px solid #c5d0c9;padding:8px;text-align:left;vertical-align:top}',
        ...
        '<body>',
        '<div class="wrap">',
        '<p><strong>AstroEconomics</strong></p>',
